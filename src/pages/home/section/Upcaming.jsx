  ...
  return (
    <section className='py-32'>
        ...
        <div className='mb-8 bg-relevantColor w-full h-[512px] flex'>
            <UpcomingCard className='w-[435px] py-[61px] px-[90px]'>
        ...
        <div className='flex justify-end	items-center gap-x-[11px] mt-12 	'>
            <CommonLink className="text-[14px] font-normal font-robotoCondance text-black leading-[16px] capitalize" to="#" text="View all Sermons" />
